...
@Component({
  selector: 'app-daily-purchase-journal',
  templateUrl: './daily-purchase-journal.component.html',
  styleUrls: ['./daily-purchase-journal.component.scss']
})
export class DailyPurchaseJournalComponent implements OnInit {
