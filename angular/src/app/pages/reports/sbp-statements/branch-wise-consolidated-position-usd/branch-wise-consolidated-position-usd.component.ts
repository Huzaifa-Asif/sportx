...
@Component({
  selector: 'app-branch-wise-consolidated-position-usd',
  templateUrl: './branch-wise-consolidated-position-usd.component.html',
  styleUrls: ['./branch-wise-consolidated-position-usd.component.scss']
})
export class BranchWiseConsolidatedPositionUsdComponent implements OnInit {
  ...
  _getReport(data) {
    ...
    this.api.getReport('BrWiseCurrencyUSD', data, 'BrWiseCurrencyUSD', this.format).then((response: any) => {
