...
class SliderComponent {
    ...
    normaliseLowValue() {
        ...
        const /** @type {?} */ normalisedValue = MathHelper.clampToRange(this.value, this.viewOptions.floor, this.viewOptions.ceil);
    ...
    normaliseHighValue() {
        ...
        const /** @type {?} */ normalisedHighValue = MathHelper.clampToRange(this.highValue, this.viewOptions.floor, this.viewOptions.ceil);
    ...
    /**
     * @param {?} changedPointer
     * @return {?}
     */
    normaliseRange(changedPointer) {
        if (this.viewOptions.stepsArray) {
            return;
        }
        if (this.range && this.value > this.highValue) {
            ...
            if (this.viewOptions.noSwitching) {
                ...
                // Apply new value as internal change
                this.internalChange = true;
                const /** @type {?} */ tempValue = this.value;
                this.value = this.highValue;
