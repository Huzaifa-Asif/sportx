...
public class CompletedCustomerTournamentAdapter extends RecyclerView.Adapter<CompletedCustomerTournamentAdapter.CompletedTournamentViewHolder>{
    ...
    public CompletedCustomerTournamentAdapter(Context context, ArrayList<Tournament> tournamentsListModel){
    ...
    @NonNull
    @Override
    public CompletedCustomerTournamentAdapter.CompletedTournamentViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater inflater = LayoutInflater.from(viewGroup.getContext());
        View view = inflater.inflate(R.layout.completed_tournament_item, viewGroup, false);
        return new CompletedCustomerTournamentAdapter.CompletedTournamentViewHolder(view);
    }
