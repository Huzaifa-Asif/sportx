    ...
    private void checkLogin(){
        ...
        if(_id != null && role != null) {
            ...
            if(role==1) {
                if(!profileCompleted)
                {
                    Intent intent = new Intent(LoginActivity.this, com.sportx.pk.activities.serviceProviderActivities.AddBookingSettingsActivity.class);
                    startActivity(intent);
                    finish();
                }
                else
                {
                    Intent intent = new Intent(LoginActivity.this, com.sportx.pk.activities.serviceProviderActivities.HomeActivity.class);
                    startActivity(intent);
                    finish();
                }
            }
