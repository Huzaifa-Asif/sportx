...
import com.sportx.pk.activities.customerActivities.PaymentOptionActivity;
...
public class PendingBookingDetailsActivity extends Menu implements View.OnClickListener {
    ...
    public void onBackPressed() {
        ...
        if(sharedPref.getUserRole() == 1) {
            Intent intent = new Intent(this, com.sportx.pk.activities.serviceProviderActivities.BookingManagementActivity.class);
                    ...
                    public void onCompleted(Exception e, Response<String> result) {
                        if(e != null) {
                            ...
                            try {
                                ...
                                Intent intent=new Intent(context,com.sportx.pk.activities.serviceProviderActivities.BookingManagementActivity.class);
