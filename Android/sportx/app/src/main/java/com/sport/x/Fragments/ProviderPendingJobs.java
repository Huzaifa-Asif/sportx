...
import com.sport.x.Adapters.ProviderInProgessAdapter;
import com.sport.x.Adapters.ProviderPendingAdapter;
...
public class ProviderPendingJobs extends Fragment {
    private Context context;
    Misc misc;
    SharedPref sharedPref;
    private ArrayList<Job> jobsListModel;
    ProviderPendingAdapter jobsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_provider_pending_jobs, container, false);
        ...
        jobsAdapter = new ProviderPendingAdapter(context, jobsListModel);
    ...
    private void pendingJobs() {
        ...
        pd.show();
        Ion.with(context)
                .load(misc.ROOT_PATH+"bookingdetails/serviceProviderPendingBookings/"+sharedPref.getEmail())
                .asString()
                .withResponse()
